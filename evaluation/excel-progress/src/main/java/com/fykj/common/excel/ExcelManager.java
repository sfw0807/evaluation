...
import com.fykj.common.excel.constants.CommentType;
import com.fykj.common.excel.model.CellColumnValue;
import com.fykj.common.excel.model.ValueBean;
import com.fykj.common.excel.utils.StringUtils;
											...
											if(sheet.getWorkbook().getClass().isAssignableFrom(HSSFWorkbook.class)) {
												if (value != null) {
													cellAppDataCell.setCellValue(new HSSFRichTextString(
															StringUtils.replaceEscapeChar(value.toString())));
												} else {
													cellAppDataCell.setCellValue(new HSSFRichTextString(""));
												}
											} else {
											...
											if (field.getType().isAssignableFrom(ValueBean.class)) {
												if (value != null) {
													...
													if(valueBean.getIsErr()) {
														if(sheet.getWorkbook().getClass().isAssignableFrom(HSSFWorkbook.class)) {
															cellAppDataCell.setCellValue(new HSSFRichTextString(
																		StringUtils.replaceEscapeChar(valueBean.getValue().toString())));
														} else {
															cellAppDataCell.setCellValue(new XSSFRichTextString(
																		StringUtils.replaceEscapeChar(valueBean.getValue().toString())));
														}
											...
											if (field.getType().isAssignableFrom(ValueBean.class)) {
												...
												if (value != null) {
													if (valueBean.getIsErr()) {
														if(sheet.getWorkbook().getClass().isAssignableFrom(HSSFWorkbook.class)) {
															cellAppDataCell.setCellValue(new HSSFRichTextString(
																	StringUtils.replaceEscapeChar(valueBean.getValue())));
														} else {
															cellAppDataCell.setCellValue(new XSSFRichTextString(
																	StringUtils.replaceEscapeChar(valueBean.getValue())));
														}
