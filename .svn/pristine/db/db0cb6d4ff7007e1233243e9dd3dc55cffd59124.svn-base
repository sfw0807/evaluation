package com.fykj.platform.util.http.loader;
...
import com.fykj.platform.util.http.annotation.PropertyConfigiration;
import com.fykj.platform.util.http.annotation.Value;
import com.fykj.platform.util.http.utils.PropertiesUtils;
